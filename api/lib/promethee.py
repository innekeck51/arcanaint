import api.lib.promethee_utils as putils
from api.lib.preference_functions import PreferenceFunctions
...
class Promethee:
  ...
  def computePairWiseComparisonMatrix(self):
    self.pi = putils.initialise_matrix(self.numberAlternatives,self.numberAlternatives)
  ...
  def computePositiveMatrix(self):
    self.positive_matrix = putils.initialise_matrix(self.numberAlternatives,self.numberAlternatives)
    for a in range(self.numberAlternatives):
      for b in range(self.numberAlternatives):
  ...
  def computeNegativeMatrix(self):
    self.negative_matrix = putils.initialise_matrix(self.numberAlternatives,self.numberAlternatives)
    for a in range(self.numberAlternatives):
      for b in range(self.numberAlternatives):
  ...
  def computePrometheeIMatrix(self):
    self.prometheeI_matrix = putils.initialise_matrix(self.numberAlternatives,self.numberAlternatives)
    for a in range(self.numberAlternatives):
      for b in range(self.numberAlternatives):
  ...
  def computePrometheeIIMatrix(self):
    self.prometheeII_matrix = putils.initialise_matrix(self.numberAlternatives,self.numberAlternatives)
    for a in range(self.numberAlternatives):
      for b in range(self.numberAlternatives):
        if self.phi_plus[a]>self.phi_plus[b]:
